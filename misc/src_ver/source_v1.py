...
# -*- coding: utf-8 -*-
"""
Created on Sat Sep 13 17:08:37 2025
...
class spheresym:
    ...
    def Horizon(self, r):
        ...
        value = invgamma[0, 0]*sdown[0]*Gamma[0, 0, 0] + invgamma[1, 1]*sdown[0]*Gamma[0, 1, 1] + invgamma[2, 2]*sdown[0]*Gamma[0, 2, 2] 
        value += - sup[0]*sup[0]*sdown[0]*Gamma[0, 0, 0] - sup[0]*sup[0]*Kij[0, 0]
        sumterm = np.einsum('ij,ij', invgamma, Kij)
        value += sumterm
